...
const Reports = () => {
  ...
  // ✅ حساب الإحصائيات مباشرة من المهام المفلترة لضمان المزامنة الفورية
  ...
  // حساب المهمة الأكثر تكراراً محلياً
  ...
  function exportPDF() {
    ...
    doc.text(
      `Total Time: ${formatMinutesToHM(localTotalMinutes)}`,
      14,
      54
    );
    doc.text(
      `Most Common Task: ${localMostCommonTask}`,
      14,
      60
    );
  ...
  function exportExcel() {
    ...
    const summarySheetData = [
      ...
      {
        Field: "Total Time",
        Value: formatMinutesToHM(localTotalMinutes),
      },
      {
        Field: "Most Common Task",
        Value: localMostCommonTask,
      },
    ];
